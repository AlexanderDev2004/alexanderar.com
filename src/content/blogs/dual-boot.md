...
5. **Install Nobara**
   ...
   - Continue install and let Nobara install {{term:GRUB|GRUB (Grand Unified Bootloader) is the boot manager that lets you choose which operating system to start.}} bootloader. </br> </br>

6. **First reboot and boot menu check**
   - After installation, reboot and you should see **{{term:GRUB|GRUB (Grand Unified Bootloader) is the menu shown at startup to choose Nobara or Windows.}}** with entries for Nobara and Windows Boot Manager.
...
```
   ...
   - Set your default boot OS and timeout in {{term:GRUB|In GRUB settings, you can choose default OS and how long the boot menu appears.}} if needed. </br> </br>
